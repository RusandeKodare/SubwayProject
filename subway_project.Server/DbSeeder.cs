        ...
        public static void Seed(AppDbContext context)
        {
            ...
            if (!context.SubCategories.Any())
            {
                ...
                context.SubCategories.AddRange(
                    new SubCategory { Name = "Subways Favorites", CategoryId = 1 },
            ...
            if (!context.Specials.Any())
            {
                context.Specials.AddRange(
                   new Specials { CategoryId = 1, SubCategoryId = 1, Name = "Spiderman Swing Swong", Price = 250, ImageUrl = "https://media.tenor.com/gZno2j_0KpMAAAAe/spodermen-funny.png" }
                );
            } 
